...
.modal{background:#fff;border-radius:18px;padding:28px;max-width:420px;width:100%;position:relative;max-height:92vh;overflow-y:auto;animation:fadeIn 0.3s ease;}
  ...
  return (
    <div className="overlay" onClick={e => e.target.classList.contains('overlay') && onClose()}>
      ...
      <div className="modal">
        ...
        {step === 2 && <>
          <h2 style={{fontFamily:"'Playfair Display',serif",marginBottom:6}}>Verify OTP</h2>
