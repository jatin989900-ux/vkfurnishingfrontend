...
.cart-btn{position:relative;background:transparent;color:#fff;border:1px solid #444;padding:7px 13px;border-radius:6px;font-size:12px;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;text-decoration:none;display:inline-flex;align-items:center;gap:5px;}
.cart-btn:hover{border-color:#C9973A;color:#C9973A;}
